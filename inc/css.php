<?php
	...
	if (!is_admin()) {
		...
		// *********************************************************************** 
			...
			// datatables
			wp_register_style( 'datatables', '//cdn.datatables.net/1.10.8/css/jquery.dataTables.min.css', array(), '');
		...
		// *********************************************************************** 
			...
			$wp_styles->add_data( 'bil-ie-only', 'conditional', 'lt IE 9' ); // add conditional wrapper around ie stylesheet
	}